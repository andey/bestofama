...
ActiveRecord::Schema.define(version: 20140403202922) do
  ...
  add_index "taggings", ["tag_id", "taggable_id"], name: "index_taggings_on_tag_id_and_taggable_id", unique: true, using: :btree
